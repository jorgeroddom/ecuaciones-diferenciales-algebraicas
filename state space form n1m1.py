...
def metodo_state_space_form(f,fy,fz,g,gy,gz,x0,xf,N,y0,z0,tol,itermax,A,b):    
    ...
    for k in range(0,N):        
        ...
        if cont == itermax:
            ...
            zk_iter = z[k]
            while(d >= tol) and (cont < itermax):  
                # Punto fijo para calcular la siguiente componente de z
                ...
                cont += 1
            if cont == itermax:
                print('El método no va bien: numero maximo de iteraciones alcanzado para z_(k+1)')
            else:
                z[k+1] = zk_iter
    return (t,y,z)
